...
4. If using EBX version earlier than 6.2.3, copy/overwrite the ebx-lz4.jar under ebx-server\compress
...
Reach out at support@onebx.com for further questions/clarifications
